    ...
    @foreach ($gigs as $gig)
        <div class="recent-gigs-slider__slide">
            ...
            <div class="recent-gigs-slider__information">
                <h2 class="recent-gigs-slider__headliner">{{ $gig['headliner_one'] }}<span>({{$gig['headliner_one_country'] }})</span></h2>
                <h3 class="recent-gigs-slider__support">+ {{ $gig['first_support_band'] }}</h3>
